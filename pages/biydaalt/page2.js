    ...
    <div className="min-h-screen flex bg-white">
      <div className="w-1/2 flex flex-col justify-start px-20 pt-10 relative">
        ...
        <div className="mx-40 pt-10">
          <h2 className="text-xl font-semibold text-center text-red-800 mb-8">Бүртгүүлэх</h2>
...
/>
          ...
          <div className="text-sm text-center text-black mb-2">Эсвэл</div>
  ...
  Facebook-ээр нэвтрэх
          ...
          <div className="text-center mt-4 text-sm text-gray-700">
            <span>Бүртгэл байхгаа юу? </span>
            <span className="underline cursor-pointer text-red-700"
              onClick={() => router.back()}>Нэвтрэх</span>
          </div>
        </div>
      </div>

      <div className="w-[1px] h-[550px] flex mt-[150px] bg-black opacity-100"></div>
