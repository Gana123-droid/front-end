  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-indigo-100 to-pink-100 text-black flex justify-center items-center">
      ...
      <div className="flex justify-center items-center">
        <div
          className="w-[300px] h-[500px] border border-white border-4 flex justify-evenly items-center flex-col shadow-xl transition delay-100 duration-500 hover:scale-125"
